...
@interface SBPrototypeControllerSettings : NSObject
- (void)setAllowPrototypeSettings;
- (BOOL)allowPrototypeSettings;
@end


@interface SBProtoSettings: NSObject
@end

@interface HiddenSettings12Listener : NSObject <LAListener> {
	BOOL _isVisible;
	NSString *_bundleID;
}
...
@implementation HiddenSettings12Listener
...
- (id)init {
	if ((self = [super init])) {
		_bundleID = @"com.mtac.HiddenSettings12.listener";
...
- (NSString *)activator:(LAActivator *)activator requiresLocalizedTitleForListenerName:(NSString *)listenerName {
	return @"HiddenSettings12";
}
// Listener description
- (NSString *)activator:(LAActivator *)activator requiresLocalizedDescriptionForListenerName:(NSString *)listenerName {
	return @"Activate Springboard Prototype Settings";
}
// Group name
